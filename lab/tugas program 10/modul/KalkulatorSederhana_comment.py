...
# membuat var global expression
expression = ""


# fungsi untuk update var expression
def press(num):
    # menggunakan var global expression
    global expression
...
# fungsi untuk menghasilkan perhitungan akhir
def equalpress():
    # menggunakan perintah try untuk menghandle error
    try:
        global expression
    ...
    # jika terdapat error maka akan dijalankan
    except:
        equation.set(" error ")
        expression = ""
...
# jika program dijalankan sebagai main program
if __name__ == "__main__":
    # membuat gui object tkinter
    gui = Tk()
        
    # memberi warna untuk background
    gui.configure(background="light green")

    # memberi judul untuk gui
    gui.title("Simple Calculator")
        
    # mmengkonfigurasi gui
    gui.geometry("270x150")
        
    # membuat equation object stringvar
    equation = StringVar()
        
    # menampilkan expression
    expression_field = Entry(gui, textvariable=equation)
        
    # mengatur grid untuk gui
    expression_field.grid(columnspan=4, ipadx=70)
        
    # fungsi untuk tombol yang akan dieksekusi
    ...
    # menjalankan gui untuk di-looping
    gui.mainloop()