...
if user__choice == '1':
    ...
    if new_user__access == 'iamgod':  # untuk admin
        ...
        if os.path.exists("./tugas program 5/users.csv"):
            with open("./tugas program 5/users.csv", "a", newline='') as users__data:
        ...
        # input user
            ...
            with open("./tugas program 5/users.csv", "x", newline='') as users__data:
                field_names = ['name', 'pass', 'access']
                writer = csv.DictWriter(users__data, fieldnames=field_names)
...
# kondisi jika user memilih login
    ...
    if os.path.exists("./tugas program 5/users.csv"):
        ...
        with open("./tugas program 5/users.csv", "r", newline='') as users__data:
            field_names = ['name', 'pass', 'access']
            ...
            if found:
                ...
                if access_index == '1':
                    with open("./tugas program 5/hello.txt", "w") as greeting_admin:
                    ...
                    with open("./tugas program 5/hello.txt", "r") as greeting_admin:
                        print("\n" + greeting_admin.read())
                        print("===============================================")
                ...
                # setelah itu program akan membuka file untuk dibaca lalu ditampilkan
                    ...
                    with open("./tugas program 5/hello.txt", "w") as greeting_guest:
                    ...
                    with open("./tugas program 5/hello.txt", "r") as greeting_guest:
                        print("\n" + greeting_guest.read())
                        print("===============================================")
            ...
            # setelah itu program akan membuka file untuk dibaca lalu ditampilkan
                ...
                with open("./tugas program 5/hello.txt", "w") as failed:
                    failed.write("LOGIN STATUS : FAILED.")
                    failed.write(
                        "\nPlease check your correct name or password.")
                with open("./tugas program 5/hello.txt", "r") as failed:
                    print("\n" + failed.read())
                    print("===============================================")
